...
type KotlinParserListener interface {
	...
	// EnterKtype is called when entering the ktype production.
	EnterKtype(c *KtypeContext)
	...
	// ExitKtype is called when exiting the ktype production.
	ExitKtype(c *KtypeContext)
